...
import com.example.kuybeer26092016.lionmonitoringdemo.adapters.AdapterStory;
...
public class FragmentStory extends Fragment {
    ...
    public static FragmentStory newInstant(String mMc_name, String mMc_id) {
        FragmentStory fd = new FragmentStory();
    ...
    public class MyThread extends  Thread {
        private boolean running;
        FragmentStory.MyHandler mainHandler;

        public MyThread(FragmentStory.MyHandler myHandler) {
            super();
        }
    ...
    private void CallData() {
        Call<List<Mis_detail>> call = mManeger.getmService().Callback_Story(mMc_id);
    ...
    public static class MyHandler extends Handler {
        ...
        private FragmentStory parent;

        public MyHandler(FragmentStory parent) {
            super();
            this.parent = parent;
        }
