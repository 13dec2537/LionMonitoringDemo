...
public class AdapterDk100 extends RecyclerView.Adapter<AdapterDk100.ViewHolder>{
    ...
    public AdapterDk100(Context context) {
        this.mList = mList;
        this.context = context;
    }

    @Override
    public AdapterDk100.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final AdapterDk100.ViewHolder holder, int position) {
